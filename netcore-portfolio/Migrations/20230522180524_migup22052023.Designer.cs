...
namespace netcore_portfolio.Migrations
{
    ...
    [Migration("20230522180524_migup22052023")]
    partial class migup22052023
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("netcore_portfolio.Models.Resume", b =>
                {
                    ...
                    b.Property<bool?>("SkillCategoryState")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("netcore_portfolio.Models.Skill", b =>
                {
                    ...
                    b.Property<int?>("SkillCategorySCID")
                        .HasColumnType("int");

                    b.Property<int?>("SkillDegre")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SkillCategorySCID");

                    b.ToTable("Skill");
                });

            modelBuilder.Entity("netcore_portfolio.Models.SkillCategory", b =>
                {
                    b.Property<int>("SCID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("netcore_portfolio.Models.Skill", b =>
                {
                    b.HasOne("netcore_portfolio.Models.SkillCategory", "SkillCategory")
                        .WithMany("Skill")
                        .HasForeignKey("SkillCategorySCID");
